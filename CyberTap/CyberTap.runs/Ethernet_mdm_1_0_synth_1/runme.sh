...
HD_PWD='X:/My Documents/SeniorDesign/CyberTap/CyberTap.runs/Ethernet_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ethernet_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ethernet_mdm_1_0.tcl

...
HD_PWD='X:/My Documents/SeniorDesign/CyberTap/CyberTap.runs/Ethernet_rst_clk_wiz_1_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ethernet_rst_clk_wiz_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ethernet_rst_clk_wiz_1_100M_0.tcl

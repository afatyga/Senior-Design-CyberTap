...
HD_PWD='X:/My Documents/SeniorDesign/CyberTap/CyberTap.runs/bd_9d5e_0_mac_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_9d5e_0_mac_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_9d5e_0_mac_0.tcl

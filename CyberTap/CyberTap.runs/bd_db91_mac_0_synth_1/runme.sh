...
HD_PWD='X:/My Documents/SeniorDesign/CyberTap/CyberTap.runs/bd_db91_mac_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_db91_mac_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_db91_mac_0.tcl

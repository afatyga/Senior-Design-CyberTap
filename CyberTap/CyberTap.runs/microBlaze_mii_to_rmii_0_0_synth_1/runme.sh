...
HD_PWD='X:/My Documents/SeniorDesign/CyberTap/CyberTap.runs/microBlaze_mii_to_rmii_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microBlaze_mii_to_rmii_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microBlaze_mii_to_rmii_0_0.tcl

...
HD_PWD='X:/My Documents/SeniorDesign/CyberTap/CyberTap.runs/axi_ethernet_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ethernet_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_ethernet_1.tcl

...
HD_PWD='X:/My Documents/SeniorDesign/CyberTap/CyberTap.runs/Ethernet_mii_to_rmii_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ethernet_mii_to_rmii_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ethernet_mii_to_rmii_0_0.tcl

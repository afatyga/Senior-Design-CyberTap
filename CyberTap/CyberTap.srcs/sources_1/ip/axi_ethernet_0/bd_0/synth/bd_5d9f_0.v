...
(* CORE_GENERATION_INFO = "bd_5d9f_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_5d9f_0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "axi_ethernet_0.hwdef" *) 
module bd_5d9f_0
   (axi_rxd_arstn,
    axi_rxs_arstn,
    axi_txc_arstn,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.GTX_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.GTX_CLK, CLK_DOMAIN bd_5d9f_0_gtx_clk, FREQ_HZ 125000000, INSERT_VIP 0, PHASE 0" *) input gtx_clk;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.REF_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.REF_CLK, CLK_DOMAIN bd_5d9f_0_ref_clk, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input ref_clk;

...
-- Date        : Sat Nov  2 13:53:55 2019
-- Host        : ECE-SD-T02 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub {x:/My
--               Documents/SeniorDesign/CyberTap/CyberTap.srcs/sources_1/bd/Ethernet/ip/Ethernet_microblaze_0_0/Ethernet_microblaze_0_0_stub.vhdl}
-- Design      : Ethernet_microblaze_0_0
...
entity Ethernet_microblaze_0_0 is
  Port ( 
    Clk : in STD_LOGIC;
    Reset : in STD_LOGIC;
...
end Ethernet_microblaze_0_0;

architecture stub of Ethernet_microblaze_0_0 is

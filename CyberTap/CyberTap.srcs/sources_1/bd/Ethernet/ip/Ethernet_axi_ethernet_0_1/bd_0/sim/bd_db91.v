...
//--------------------------------------------------------------------------------
//Command: generate_target bd_db91.bd
//Design : bd_db91
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_db91,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_db91,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Ethernet_axi_ethernet_0_1.hwdef" *) 
module bd_db91
   (axi_rxd_arstn,
    axi_rxs_arstn,
    axi_txc_arstn,
  ...
  assign mac_mii_RXD = mii_rxd[3:0];
  assign mac_mii_RX_CLK = mii_rx_clk;
  assign mac_mii_RX_DV = mii_rx_dv;
  assign mac_mii_RX_ER = mii_rx_er;
  assign mac_mii_TX_CLK = mii_tx_clk;
  ...
  assign mii_tx_en = mac_mii_TX_EN;
  assign mii_tx_er = mac_mii_TX_ER;
  assign mii_txd[3:0] = mac_mii_TXD;
  ...
  bd_db91_mac_0 mac
       (.glbl_rstn(eth_buf_RESET2TEMACn),
        ...
        .tx_mac_aclk(mac_tx_mac_aclk),
        .tx_reset(mac_tx_reset));
  bd_db91_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(s_axi_lite_resetn_1),
        .Res(util_vector_logic_0_Res));
  bd_db91_xlconstant_0_0 xlconstant_0

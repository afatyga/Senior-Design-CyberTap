...
#
# Generated by export_simulation on Sat Nov 02 13:50:42 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './Ethernet.sh' script.

./Ethernet.sh -reset_run
...
./Ethernet.sh -noclean_files

For more information on the script, please type './Ethernet.sh -help'.

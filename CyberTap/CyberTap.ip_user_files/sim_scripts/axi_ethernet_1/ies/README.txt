...
#
# Generated by export_simulation on Sat Nov 02 13:27:45 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './axi_ethernet_1.sh' script.

./axi_ethernet_1.sh -reset_run
...
./axi_ethernet_1.sh -noclean_files

For more information on the script, please type './axi_ethernet_1.sh -help'.
